...
from src.models.grssm.kernels.vandermonde_reservoir import VandermondeReservoir
from src.models.grssm.kernels.mini_vandermonde_reservoir import MiniVandermondeReservoir
...
class FFTConvReservoir(nn.Module):
    ...
    def step(self, u, x=None):
        ...
        y = torch.cat((y.real, y.imag), dim=1)  # (B, 2H)
    ...
    def forward(self, u):
        ...
        y = torch.cat((y.real, y.imag), dim=1)  # (B, 2H, L)
